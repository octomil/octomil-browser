...
/**
 * Heuristic host substrings for URL-based inference. Order matters —
 * staging is checked before production so the more-specific
 * `api.staging.octomil.com` matches before `api.octomil.com`.
 */
